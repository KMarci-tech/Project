...
public class Texture {
	...
	SpriteSheet bs, ps, ss, es, shu, co, si;
	...
	private BufferedImage sign_sheet = null;
	...
	public BufferedImage[] sign = new BufferedImage[1];
	...
	public Texture() {
		...
		try {
			...
			coin_sheet = loader.loadImage("/coin_sheet.png");
			sign_sheet = loader.loadImage("/sign_sheet.png");
		}catch(Exception e) {
			e.printStackTrace();
		}
		...
		co = new SpriteSheet(coin_sheet);
		si = new SpriteSheet(sign_sheet);
	...
	private void getTextures() {
		...
		coin[0] = co.grabImage(1,1,12,12);
		
		sign[0] = si.grabImage(1,1,32,32);
